...
/*! @name PIO0_0 (number 54), SW
  @{ */

/* Symbols to be used with GPIO driver */
#define BOARD_INITADCPINS_SW_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITADCPINS_SW_GPIO_PIN_MASK (1U << 0U) /*!<@brief GPIO pin mask */
#define BOARD_INITADCPINS_SW_PORT 0U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITADCPINS_SW_PIN 0U                   /*!<@brief PORT pin number */
#define BOARD_INITADCPINS_SW_PIN_MASK (1U << 0U)      /*!<@brief PORT pin mask */
                                                      /* @} */
